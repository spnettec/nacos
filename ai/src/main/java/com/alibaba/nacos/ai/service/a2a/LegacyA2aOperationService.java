 ...
 */
@Component
public class LegacyA2aOperationService implements A2aOperationService {
    ...
    public LegacyA2aOperationService(ConfigQueryChainService configQueryChainService,
    ...
    public void releaseAgent(AgentCard agentCard, String namespaceId, String registrationType,
        ...
        try {
            ...
            if (ErrorCode.AGENT_NOT_FOUND.getCode() == e.getDetailErrCode()) {
                registerAgent(agentCard, namespaceId, registrationType);
            } else if (ErrorCode.AGENT_VERSION_NOT_FOUND.getCode() == e.getDetailErrCode()) {
                updateAgentCard(agentCard, namespaceId, registrationType, setAsLatest);
            } else {
                throw e;
            }
        }
    ...
    public AgentCardDetailInfo getAgentCardForClient(String namespaceId, String agentName,
        ...
        return getAgentCard(namespaceId, agentName, version, registrationType);
    }
