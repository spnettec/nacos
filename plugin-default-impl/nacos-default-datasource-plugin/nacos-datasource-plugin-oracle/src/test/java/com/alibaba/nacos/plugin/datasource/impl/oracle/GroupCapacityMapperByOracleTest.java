...
class GroupCapacityMapperByOracleTest {
    ...
    private GroupCapacityMapperByOracle groupCapacityMapperByOracle;
    
    @BeforeEach
    void setUp() throws Exception {
        groupCapacityMapperByOracle = new GroupCapacityMapperByOracle();
    ...
    void testGetTableName() {
        String tableName = groupCapacityMapperByOracle.getTableName();
        assertEquals(TableConstant.GROUP_CAPACITY, tableName);
    }
    
    @Test
    void testGetDataSource() {
        String dataSource = groupCapacityMapperByOracle.getDataSource();
    ...
    void testUpdateUsageByWhere() {
        MapperResult mapperResult = groupCapacityMapperByOracle.updateUsageByWhere(context);
        assertEquals(mapperResult.getSql(),
