...
class NacosClientPropertyAction extends Action {
    ...
    @Override
    public void begin(SaxEventInterpretationContext saxEventInterpretationContext, String s, Attributes attributes)
        ...
        ActionUtil.setProperty(new ModelInterpretationContext(saxEventInterpretationContext.getContext()),
                name, getValue(source, defaultValue), scope);
    }

    @Override
    public void end(SaxEventInterpretationContext saxEventInterpretationContext, String s) throws ActionException {
