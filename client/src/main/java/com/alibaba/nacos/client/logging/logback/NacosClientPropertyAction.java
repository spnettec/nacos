...
class NacosClientPropertyAction extends Action {
    ...
    @Override
    public void begin(SaxEventInterpretationContext ic, String elementName, Attributes attributes) throws ActionException {
        ...
        ActionUtil.setProperty(new ModelInterpretationContext(ic.getContext()), name, getValue(source, defaultValue), scope);
    }
    
    @Override
    public void end(SaxEventInterpretationContext ic, String name) throws ActionException {
