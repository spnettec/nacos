...
public class NacosRuntimeHints implements RuntimeHintsRegistrar {
    ...
    private final Class<?>[] javaClasses = {byte.class, byte.class, byte[].class, boolean.class,
        ...
        java.nio.channels.FileChannel.class, java.security.AccessController.class,
        java.sql.Date.class,
        java.sql.Driver.class, java.sql.DriverManager.class, java.sql.Time.class,
        java.sql.Timestamp.class,
        java.util.concurrent.locks.LockSupport.class, java.util.Optional.class,
