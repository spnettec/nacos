...
class ExternalStoragePaginationHelperImplTest {
    ...
    void testFetchPageWithoutResult() {
        when(jdbcTemplate.queryForObject(QUERY_COUNT_SQL, Integer.class, new Object[] {})).thenReturn(null);
        assertThrows(IllegalArgumentException.class,
    ...
    void testFetchPageOnePage() {
        when(jdbcTemplate.queryForObject(QUERY_COUNT_SQL, Integer.class, new Object[] {})).thenReturn(1);
        when(jdbcTemplate.query(QUERY_SQL, rowMapper, new Object[] {})).thenReturn(
    ...
    void testFetchPageMorePageFull() {
        when(jdbcTemplate.queryForObject(QUERY_COUNT_SQL, Integer.class, new Object[] {})).thenReturn(2);
        when(jdbcTemplate.query(QUERY_SQL, rowMapper, new Object[] {})).thenReturn(
                Collections.singletonList(new Object()));
        Page<Object> actual = externalStoragePaginationHelper.fetchPage(QUERY_COUNT_SQL, QUERY_SQL, new Object[] {}, 1,
                1, rowMapper);
    ...
    void testFetchPageMorePageNotFull() {
        when(jdbcTemplate.queryForObject(QUERY_COUNT_SQL, Integer.class, new Object[] {})).thenReturn(3);
        List<Object> pageItems = new LinkedList<>();
        pageItems.add(new Object());
        pageItems.add(new Object());
        when(jdbcTemplate.query(QUERY_SQL, rowMapper, new Object[] {})).thenReturn(pageItems);
        Page<Object> actual = externalStoragePaginationHelper.fetchPage(QUERY_COUNT_SQL, QUERY_SQL, new Object[] {}, 1,
                2, rowMapper);
